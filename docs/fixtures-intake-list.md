...
| F13 | `fixtures/13_wrong_ext_hwp.dat` | Synthetic rename from COMMIT_OK HWP | inherits base | **SYNTHETIC_LATER** |
| F14 | `fixtures/14_wrong_ext_hwpx.pdf` | Synthetic rename from COMMIT_OK HWPX | inherits base | **SYNTHETIC_LATER** |
| F16 | `fixtures/16_corrupt_truncated.hwp` | SafeDocs example_corrupt.hwp OR synthetic truncate | SafeDocs LICENSE_UNKNOWN; prefer synthetic | **HOLD_LICENSE** / prefer **SYNTHETIC_LATER** |
| F18 | `fixtures/18_table_image_mix.hwp` | SafeDocs example_with_table.hwp | LICENSE_UNKNOWN | **HOLD_LICENSE** |
| F21 | `fixtures/21_prettyprinted_bad.hwpx` | Synthetic prettyprint-bad from COMMIT_OK HWPX | derived | **SYNTHETIC_LATER** |
...
2. F13/F14/F21 synthetic after a COMMIT_OK HWPX/HWP exists. F16 prefer synthetic truncate (do **not** commit SafeDocs `example_corrupt.hwp`).
...
*Updated 2026-09-10 KST. COMMIT_OK hub-A/B/C binaries are in git. No HOLD_LICENSE binaries.*
