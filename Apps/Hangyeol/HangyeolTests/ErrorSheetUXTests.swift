...
final class HelpUXTests: XCTestCase {
    func testKnownLimitsAreScannableKoreanFacts() {
        ...
        XCTAssertEqual(help.limits.count, 3)
        XCTAssertEqual(help.limits.map(\.id), ["layout", "wysiwyg", "hwp-save"])
        ...
        XCTAssertTrue(help.limits[0].text.contains("조판"))
        XCTAssertTrue(help.limits[1].text.contains("WYSIWYG"))
        XCTAssertTrue(help.limits[2].text.contains(".hwp"))
        XCTAssertTrue(help.limits[2].text.contains("HWPX"))
